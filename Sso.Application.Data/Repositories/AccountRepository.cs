...
namespace Sso.Application.Data.Repositories
{
    public interface IAccountRepository
    {
        ...
        Task<Dtos.ExternalLoginResult> PerformExternalLogin();
    }
    internal class AccountRepository : IAccountRepository
    {
        ...
        public async Task<Dtos.ExternalLoginResult> PerformExternalLogin()
        {
            ...
            {
                return new Dtos.ExternalLoginResult
                {
                    Status = Enums.ELoginStatus.Success,
            ...
            else if (signinResult.RequiresTwoFactor)
            {
                return new Dtos.ExternalLoginResult
                {
                    Status = Enums.ELoginStatus.RequiresTwoFactor,
                    Provider = info.LoginProvider,
                    User = new Dtos.User
                    {
                        Id = user.Id,
            ...
            else
            {
                return new Dtos.ExternalLoginResult
                {
                    Status = Enums.ELoginStatus.Failed,
                };
            }
        }
    }
